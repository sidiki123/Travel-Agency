...
if ( ! class_exists( 'travel_ultimate_Latest_Post' ) ) :

     
    class travel_ultimate_Latest_Post extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tp_widget_popular_post = array(
                ...
                'description' => esc_html__( 'Retrive latest posts.', 'travel-ultimate' ),
            );
            parent::__construct( 'travel_ultimate_latest_post', esc_html__( 'TP : Latest Posts', 'travel-ultimate' ), $tp_widget_popular_post );
        }
        ...
        public function form( $instance ) {
            $tp_title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Latest Posts', 'travel-ultimate' );
            $tp_number     = isset( $instance['number'] ) ? absint( $instance['number'] ) : 3;
           ?>
           ...
           <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show:', 'travel-ultimate' ); ?></label>
