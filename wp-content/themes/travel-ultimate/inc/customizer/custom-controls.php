 ...
 */
class travel_ultimate_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
      ...
      <?php endif; ?>
       <select <?php $this->link(); ?>>
			<?php
			printf( '<option value="%s" %s>%s</option>', '', selected( $this->value(), '', false ), esc_html__('--None--', 'travel-ultimate') );
			?>
 ...
 * @see WP_Customize_Control
 */
class travel_ultimate_Dropdown_Category_Control extends WP_Customize_Control {
...
class travel_ultimate_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class travel_ultimate_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="travel-ultimate-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class travel_ultimate_Custom_Radio_Image_Control extends WP_Customize_Control {
...
Class travel_ultimate_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
