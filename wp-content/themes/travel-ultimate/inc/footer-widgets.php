...
class Travel_Ultimate_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'travel_ultimate';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'travel-ultimate' ), $i ),
...
// Initialize.
$travel_ultimate_footer_widgets = new Travel_Ultimate_Footer_Widgets();
