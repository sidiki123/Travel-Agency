...
class Fusion_White_Label_Branding_Admin {
	...
	public function admin_menu() {
		...
		$dashboard     = add_menu_page( esc_attr__( 'Avada White Label Branding', 'fusion-white-label-branding' ), esc_attr__( 'Avada Branding', 'fusion-white-label-branding' ), $capability, 'avada-white-label-branding-admin', [ $this, 'dashboard' ], 'dashicons-avada-wlb', '3.555555' );
