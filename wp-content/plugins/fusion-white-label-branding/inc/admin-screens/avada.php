...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
	...
	<section class="avada-db-card fusion-white-label-option">
		<div class="fusion-white-label-option-title">
			...
			<p class="description">
				<?php
				// Translators: Avada.
				printf( __( 'Controls the menu icon image on %s admin menu and replaces the ThemeFusion logo. <br/><strong>Recommended size:</strong> 20px wide x 20px high.', 'fusion-white-label-branding' ), 'Avada' ); // phpcs:ignore WordPress.Security.EscapeOutput
				?>
			</p>
		</div>
		<div class="fusion-white-label-option-input">
	...
	<section class="avada-db-card fusion-white-label-option">
		...
		<div class="fusion-white-label-option-input">
			...
			<p class="description"><?php esc_html_e( 'Dahboard welcome section heading.', 'fusion-white-label-branding' ); ?></p>
			<br/>
			...
			<p class="description"><?php esc_html_e( 'Dahboard welcome section sub-heading.', 'fusion-white-label-branding' ); ?></p>
			<br/>
			<?php
			...
			?>
			<p class="description"><?php esc_html_e( 'Dahboard welcome section content.', 'fusion-white-label-branding' ); ?></p>
		</div>
	</section>
