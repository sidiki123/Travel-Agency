<?php
/**
 * Travelbiz Widget Base Widget Class
 * @link http://codex.wordpress.org/Widgets_API#Developing_Widgets
 * @since Travelbiz 1.0.0
 */

if( ! class_exists( 'Travelbiz_Base_Widget' ) ):

class Travelbiz_Base_Widget extends WP_Widget {
            ...
            $this->get_html_description( $field );
             break; 
   				default:
   					...
   					echo esc_html__( 'Type Not Supported.', 'travelbiz' );
   					break;
   			}
   			?>
            <?php if( $field[ 'type'] == 'checkbox' && isset( $field[ 'label' ] ) ): ?>
   ...
   public function get_html_dropdown_categories( $field ) {
       $dropdown = wp_dropdown_categories(
           array(
               ...
               'echo'              => 0,
               'show_option_none'  => esc_html__( '&mdash; Select &mdash;', 'travelbiz' ),
               'option_none_value' => '0',
   ...
   public function get_menu( $id ){
        ...
        return wp_nav_menu( apply_filters( 'travelbiz_widget_nav_menu_args', $nav_menu_args, $nav_menu, $id ) );
   }
